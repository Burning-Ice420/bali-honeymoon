/*! For license information please see 3dd13573d5b77f96.vendor.js.LICENSE.txt */
    ...
    [98821], {
            ...
            function r(t, e) {
                if (t && e) {
                    ...
                    var i = r.get(e) || function(n) {
                        var r = o(t, n),
                            i = o(e, n),
                            s = "function" == typeof r ? r : function() {
                                o(t, null)
                            },
        ...
        88085: (t, e) => {
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.Snapshot = e.Variable = void 0;
            class n {
                constructor(t) {
                    this.name = (null == t ? void 0 : t.name) || "", this.defaultValue = null == t ? void 0 : t.defaultValue
                }
                get() {
        ...
        148676: (t, e) => {
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.enableAsyncContextRuntime = void 0;
            e.enableAsyncContextRuntime = null != globalThis.flags && (!0 === globalThis.flags["3c263f"] || !0 === globalThis.flags["7a8de8f"] || !0 === globalThis.flags.a845bec5) || (() => {
                var t, e, n;
                if (!(null === (t = null === globalThis || void 0 === globalThis ? void 0 : globalThis.flags) || void 0 === t ? void 0 : t.fe634b10)) return !1;
                const r = null === (n = null === (e = null === globalThis || void 0 === globalThis ? void 0 : globalThis.location) || void 0 === e ? void 0 : e.search) || void 0 === n ? void 0 : n.substring(1),
                    o = "enableAsyncContextRuntime",
                    i = null == r ? void 0 : r.split("&"),
                    s = null == i ? void 0 : i.find((t => {
                        const [e] = t.split("=");
                        if (e === o) return !0;
                        const n = e.match(/^flags?\.(.+)$/);
                        return (null == n ? void 0 : n[1]) === o
                    }));
                if (void 0 === s) return !1;
                return "false" !== s.split("=")[1]
            })()
        },
        159247: (t, e, n) => {
            "use strict";
        ...
        192897: (t, e, n) => {
            ...
            ! function() {
                ...
                function k(t, e, n, r, o, i, s) {
                    this.v = t, this.B = e, this.c = n, this.a = r, this.s = s || "BESbswy", this.f = {}, this.w = o || 3e3, this.u = i || null, this.m = this.j = this.h = this.g = null, this.g = new P(this.c, this.s), this.h = new P(this.c, this.s), this.j = new P(this.c, this.s), this.m = new P(this.c, this.s), t = I(t = new _(this.a.c + ",serif", A(this.a))), this.g.a.style.cssText = t, t = I(t = new _(this.a.c + ",sans-serif", A(this.a))), this.h.a.style.cssText = t, t = I(t = new _("serif", A(this.a))), this.j.a.style.cssText = t, t = I(t = new _("sans-serif", A(this.a))), this.m.a.style.cssText = t, L(this.g), L(this.h), L(this.j), L(this.m)
                }
                ...
                function q(t) {
                    0 == --t.f && t.j && (t.m ? ((t = t.a).g && p(t.f, [t.a.c("wf", "active")], [t.a.c("wf", "loading"), t.a.c("wf", "inactive")]), N(t, "active")) : R(t.a))
                }
                        ...
                        if (0 === n.length && i) R(e.a);
                            ...
                            for (u = 0; u < n.length; u++) {
                                var l = n[u],
                                    ...
                                    h = e.a,
                                    d = l;
                                if (h.g && p(h.f, [h.a.c("wf", d.c, A(d).toString(), "loading")]), N(h, "fontloading", d), h = null, null === V)
                                    if (window.FontFace) {
                                ...
                                h = V ? new j(s(e.g, e), s(e.h, e), e.c, l, e.s, f) : new k(s(e.g, e), s(e.h, e), e.c, l, e.s, t, f), c.push(h)
                            }
                ...
                G.prototype.g = function(t) {
                    var e = this.a;
                    e.g && p(e.f, [e.a.c("wf", t.c, A(t).toString(), "active")], [e.a.c("wf", t.c, A(t).toString(), "loading"), e.a.c("wf", t.c, A(t).toString(), "inactive")]), N(e, "fontactive", t), this.m = !0, q(this)
        ...
        245307: (t, e, n) => {
            ...
            const r = n(88085),
                o = n(472537),
                i = n(148676),
                s = i.enableAsyncContextRuntime ? o.Variable : r.Variable;
            e.rT = s;
            const a = i.enableAsyncContextRuntime ? o.Snapshot : r.Snapshot;
            e.Fm = a
        },
        257288: (t, e, n) => {
            "use strict";
        ...
        332386: (t, e, n) => {
            ...
            var d = !!String.prototype.startsWith && "_a".startsWith("a", 1),
                ...
                w = !0;
            try {
                w = "a" === (null === (r = N("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) || void 0 === r ? void 0 : r[0])
            } catch (k) {
                w = !1
            }
            ...
            if (w) {
                var C = N("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
                _ = function(t, e) {
                    var n;
                    ...
                    switch (f) {
                        ...
                        case "time":
                            ...
                            if (this.bumpIf(",")) {
                                ...
                                if (0 === (g = R(A.val)).length) return this.error(i.F.EXPECT_ARGUMENT_STYLE, p(this.clonePosition(), this.clonePosition()));
                                d = {
                                    style: g,
                        ...
                        case "select":
                            ...
                            var O, N = this.tryParsePluralOrSelectOptions(t, f, e, w);
                            if (N.err) return N;
                            if ((O = this.tryParseArgumentClose(r)).err) return O;
            ...
            const a = t => ({
                ...
                async fn(e) {
                    ...
                    const x = w / 2 - _ / 2,
                        ...
                        P = A / 2 - y[v] / 2 + x,
                        L = (0, r.qE)(N, P, C),
                        I = !c.arrow && null != (0, r.Sg)(i) && P !== L && s.reference[v] / 2 - (P < N ? S : R) - y[v] / 2 < 0,
                        j = I ? P < N ? P - N : P - C : 0;
                    return {
                        [d]: p[d] + j,
                        data: {
                    ...
                    return void 0 === t && (t = {}), {
                        ...
                        async fn(e) {
                            ...
                            if (O = [...O, {
                                ...
                                var S, R;
                                const t = ((null == (S = a.flip) ? void 0 : S.index) || 0) + 1,
                                    e = T[t];
                                if (e) return {
                                    data: {
                                        index: t,
                                ...
                                let n = null == (R = O.filter((t => t.overflows[0] <= 0)).sort(((t, e) => t.overflows[1] - e.overflows[1]))[0]) ? void 0 : R.placement;
                                if (!n) switch (v) {
                                    case "bestFit":
                                        {
                                            var N;
                                            const t = null == (N = O.map((t => [t.placement, t.overflows.filter((t => t > 0)).reduce(((t, e) => t + e), 0)])).sort(((t, e) => t[1] - e[1]))[0]) ? void 0 : N[0];t && (n = t);
                                            break
                                        }
        ...
        447524: (t, e) => {
            ...
            class j {
                constructor(t) {
                    var e;
                    this.id = f(), this.resourceType = "texture", this.textureType = "image", this.size = I, this.numberFormat = "u8", this.source = t.source, this.name = t.name, this.alpha = t.alpha || L, this.anisotropy = null != (e = t.anisotropy) ? e : 0, this.colorFormat = t.colorFormat || "rgba"
                }
                get width() {
            ...
            class k {
                constructor(t) {
                    var e;
                    this.id = f(), this.resourceType = "texture", this.textureType = "binary", this.size = I, this.source = t.source, this.name = t.name, this.alpha = t.alpha || L, this.width = t.width, this.height = t.height, this.anisotropy = null != (e = t.anisotropy) ? e : 0
                }
                get colorFormat() {
            ...
            function Ct() {
                var t = new Nt(9);
                return Nt != Float32Array && (t[1] = 0, t[2] = 0, t[3] = 0, t[5] = 0, t[6] = 0, t[7] = 0), t[0] = 1, t[4] = 1, t[8] = 1, t
            }

            function Pt() {
                var t = new Nt(16);
                return Nt != Float32Array && (t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0), t[0] = 1, t[5] = 1, t[10] = 1, t[15] = 1, t
            }
            ...
            function Mt(t, e, n, r) {
                var o, i, s, a, u, c, l, f, h, p, d = e[0],
                    ...
                    w = n[1],
                    _ = n[2];
                return Math.abs(d - E) < Rt && Math.abs(v - w) < Rt && Math.abs(y - _) < Rt ? Lt(t) : (l = d - E, f = v - w, h = y - _, o = b * (h *= p = 1 / Math.hypot(l, f, h)) - g * (f *= p), i = g * (l *= p) - m * h, s = m * f - b * l, (p = Math.hypot(o, i, s)) ? (o *= p = 1 / p, i *= p, s *= p) : (o = 0, i = 0, s = 0), a = f * s - h * i, u = h * o - l * s, c = l * i - f * o, (p = Math.hypot(a, u, c)) ? (a *= p = 1 / p, u *= p, c *= p) : (a = 0, u = 0, c = 0), t[0] = o, t[1] = a, t[2] = l, t[3] = 0, t[4] = i, t[5] = u, t[6] = f, t[7] = 0, t[8] = s, t[9] = c, t[10] = h, t[11] = 0, t[12] = -(o * d + i * v + s * y), t[13] = -(a * d + u * v + c * y), t[14] = -(l * d + f * v + h * y), t[15] = 1, t)
            }

            function Dt() {
                var t = new Nt(3);
                return Nt != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0), t
            }
            ...
            function Ht() {
                var t = new Nt(4);
                return Nt != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0), t[3] = 1, t
            }
            Dt(),
                function() {
                    var t = function() {
                        var t = new Nt(4);
                        return Nt != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0, t[3] = 0), t
                    }()
                }();
            ...
            const Qt = t => {
                ...
                ae = (t, e) => {
                    ...
                    return {
                        ...
                        placeholder: ie(n),
                        targets: se(t.mesh),
                        transform: t.translation.length > 0 ? jt(Pt(), Ut(t.translation[0], t.translation[1], t.translation[2])) : Pt(),
            ...
            e.AdditiveBlending = {
            ...
            }, e.ImageTexture = j, e.MockWebGLRenderingContext = class {
                constructor(t) {
                ...
                updateAll({
                    ...
                    if (t)
                        for (const e of this.renderables) t.uCameraPosition && (e.uniforms[St] = t.uCameraPosition), t.uMVPMatrix && (e.uniforms[At] = t.uMVPMatrix), t.uNormalMatrix && (e.uniforms[Ot] = t.uNormalMatrix)
                }
                updateOne({
                    id: t,
                    textures: e
                ...
                createMVPMatrix(t) {
                    ...
                    const e = Ut(0, 0, 0),
                        n = Ut(0, 1, 0);
                    return Mt(this.viewMatrix, this.cameraPosition, e, n), It(this.modelViewProjectionMatrix, this.viewMatrix, this.modelMatrix), It(this.modelViewProjectionMatrix, this.projectionMatrix, this.modelViewProjectionMatrix), Array.from(this.modelViewProjectionMatrix)
                }
                ...
                createNormalMatrix() {
                    ...
                    return function(t, e) {
                        var n = e[0],
                            ...
                            R = f * m - p * v,
                            N = h * m - p * y,
                            C = b * N - g * R + E * S + w * O - _ * x + T * A;
                        C && (C = 1 / C, t[0] = (a * N - u * R + c * S) * C, t[1] = (u * O - s * N - c * x) * C, t[2] = (s * R - a * O + c * A) * C, t[3] = (o * R - r * N - i * S) * C, t[4] = (n * N - o * O + i * x) * C, t[5] = (r * O - n * R - i * A) * C, t[6] = (v * T - y * _ + m * w) * C, t[7] = (y * E - d * T - m * g) * C, t[8] = (d * _ - v * E + m * b) * C)
                ...
                equation: "add"
            }, e.RenderTexture = B, e.Renderable = N, e.Renderer = class {
                constructor(t) {
        ...
        472537: (t, e) => {
            ...
            class r {
                constructor() {
                    null != e.currentSnapshot.value && (this.parentSnapshot = e.currentSnapshot.value), this.run = this.run.bind(this)
                }
                run(t, ...n) {
                ...
                static wrap(t) {
                    ...
                    if (t[n]) return console.warn("Snapshot.wrap should not be called more than once on a function"), t;
                    const r = e.currentSnapshot.value,
                        o = function(...n) {
                            const o = e.currentSnapshot.value;
                            e.currentSnapshot.value = r;
                            try {
                                return t.call(this, ...n)
                            } finally {
                                e.currentSnapshot.value = o
                            }
                        };
                    return o[n] = !0, o
                }
            ...
            e.Variable = class {
                constructor(t) {
                    this.snapshotToValue = new WeakMap, this.name = (null == t ? void 0 : t.name) || "", this.defaultValue = null == t ? void 0 : t.defaultValue
                }
                get() {
                ...
                run(t, e, ...n) {
                    const o = new r;
                    return this.snapshotToValue.set(o, t), o.run(e, ...n)
                }
        ...
        483305: (t, e, n) => {
            ...
            function f(t) {
                ...
                }), []), R = p || _, N = d || A, C = o.useRef(null), P = o.useRef(null), L = o.useRef(b), I = null != y, j = l(y), k = l(h), B = o.useCallback((() => {
                ...
                s((() => (M.current = !0, () => {
                    ...
                    if (R && (C.current = R), N && (P.current = N), R && N) {
                        if (j.current) return j.current(R, N, B);
                        B()
                    }
                }), [R, N, B, j, I]);
                const D = o.useMemo((() => ({
        ...
        536618: (t, e, n) => {
            ...
            function h(t, e) {
                ...
                var n = t;
                t.then((0, r.XI)("observableFromPromise-resolve", (function(t) {
                    n.value = t, n.state = c
            ...
            function p(t, e, n) {
                ...
                var s = !1,
                    ...
                    l = (0, r.MN)("ResourceBasedObservable", (function() {
            ...
            function v(t, e) {
                ...
                return (n = {
                    subscribe: function(t) {
                        return "function" == typeof t ? {
                            unsubscribe: (0, r.lB)(o, (function(e) {
                                var n = e.newValue;
                                return t(n)
                            }), e)
                ...
                }), d([r.sH.ref], t.prototype, "current", void 0), d([r.XI.bound], t.prototype, "next", null), d([r.XI.bound], t.prototype, "complete", null), d([r.XI.bound], t.prototype, "error", null)
            }();
            var y = function() {
            ...
            ! function() {
                function t(t) {
                    ...
                    }), (0, r.Gn)(this), i((0, r.OB)(t), "createViewModel expects an observable object");
                    var n = a(this);
                    a(t).forEach((function(o) {
                        var s;
                        if (!n.includes(o) && o !== r.BQ && "__mobxDidRunLazyInitializers" !== o) {
                            if (i(-1 === b.indexOf(o), "The propertyname " + o + " is reserved and cannot be used with viewModels"), (0, r.H8)(t, o)) {
                                var a = (0, r.Mr)(t, o),
                                    u = a.derivation.bind(e),
                                    c = null === (s = a.setter_) || void 0 === s ? void 0 : s.bind(e);
                                e.localComputedValues.set(o, (0, r.EW)(u, {
                                    set: c
                                }))
                            }
                            ...
                            Object.defineProperty(e, o, y(y({}, f), {
                                configurable: !0,
                                get: function() {
                                    return (0, r.H8)(t, o) ? e.localComputedValues.get(o).get() : e.isPropertyDirty(o) ? e.localValues.get(o) : e.model[o]
                                },
                                set: (0, r.XI)((function(n) {
                                    (0, r.H8)(t, o) ? e.localComputedValues.get(o).set(n): n !== e.model[o] ? e.localValues.set(o, n) : e.localValues.delete(o)
                                }))
                            }))
                        }
                    }))
                    ...
                    value: function() {
                        ...
                        (0, r.HP)(this.localValues).forEach((function(e) {
                            var n = t.localValues.get(e),
                                o = t.model[e];
                            (0, r.Fq)(o) ? o.replace(n): (0, r.uz)(o) ? (o.clear(), o.merge(n)) : (0, r.YQ)(n) || (t.model[e] = n)
                ...
                }), m([r.EW], t.prototype, "isDirty", null), m([r.EW], t.prototype, "changedValues", null), m([r.XI.bound], t.prototype, "submit", null), m([r.XI.bound], t.prototype, "reset", null), m([r.XI.bound], t.prototype, "resetProperty", null)
            }();
            ...
            function w(t) {
                return void 0 === t && (t = 1e3), (0, r.Tx)() ? (E[t] || (E[t] = "number" == typeof t ? function(t) {
                    var e;
                    return p((function(n) {
            ...
            function _(t) {
                return (0, r.Tx)() || console.warn("'expr' should only be used inside other reactive functions."), (0, r.EW)(t).get()
            }
            var T = function() {
            ...
            function A(t, e) {
                ...
                return function(e) {
                    ...
                    if (l) return l.get();
                    if (!a && !(0, r.Tx)()) {
                        !c && (null !== (i = o.requiresReaction) && void 0 !== i ? i : (0, r.sG)().computedRequiresReaction) && (console.warn("Invoking a transformer from outside a reactive context won't be memoized and is cleaned up immediately, unless keepAlive is set."), c = !0);
                        var f = t(e);
                        return u && u(f, e), f
                    }
                    return l = function(e) {
            ...
            var x, O = (x = function(t, e) {
                ...
                S = (function(t) {
                    function e(e, n, o) {
                        ...
                        return l._disposeBaseObserver = (0, r.lB)(l._base, (function(t) {
                            if ("splice" === t.type)(0, r.Rn)((function() {
                ...
                R = function() {
                    ...
                    return Object.defineProperty(t.prototype, "entry", {
                        ...
                        value: function(t) {
                            ...
                            return this.currentVersion >= Number.MAX_SAFE_INTEGER && (this.currentVersion = 0), this.currentVersion++, new S(this.store, t, this.currentVersion, this.checkVersion)
                        }
                    }), t
                }(),
                N = function() {
            ...
            function P(t, e) {
                if (void 0 === e && (e = !1), (0, r.ve)(t)) throw new Error("computedFn shouldn't be used on actions");
                var n = !1,
                    o = 0,
                    i = "boolean" == typeof e ? {
                        keepAlive: e
                ...
                return function() {
                    ...
                    if (!i.keepAlive && !(0, r.Tx)()) {
                        !n && (null !== (e = i.requiresReaction) && void 0 !== e ? e : (0, r.sG)().computedRequiresReaction) && (console.warn("Invoking a computedFn from outside a reactive context won't be memoized and is cleaned up immediately, unless keepAlive is set."), n = !0);
                        var h = t.apply(this, u);
                        return i.onCleanup && i.onCleanup.apply(i, C([h], u)), h
                    }
                    var p = (0, r.EW)((function() {
                        return l = t.apply(a, u)
                    }), N(N({}, i), {
                        name: "computedFn(" + (i.name || t.name) + "#" + ++o + ")"
                    }));
                    return f.set(p), i.keepAlive || (0, r.q$)(p, (function() {
        ...
        728543: (t, e, n) => {
            ...
            function m(t) {
                ...
                function N(t) {
                    (0, r.A)(H, t), H.length = n.length, R.notifyListeners(H.location, H.action)
                }
                            ...
                            if (t) {
                                ...
                                if (o)
                                    if (n.replaceState({
                                        ...
                                        var u = k.indexOf(H.location.key); - 1 !== u && (k[u] = i.key), N({
                                            action: r,
                                            location: i
                                        })
                                    }
        ...
        903538: (t, e, n) => {
            ...
            const r = n(205482).createContext(null)
        },
        911832: t => {
            "use strict";
                ...
                return function(t) {
                    ...
                    var O = function(t) {
                        ...
                        k = function(t) {
                            ...
                            }, e.blotName = "block", e.scope = s.BLOCK_BLOT, e.tagName = "P", e.allowedChildren = [I, e, _], e
                        }(y),
                        B = function() {
                            var t = function(e, n) {
                                return t = Object.setPrototypeOf || {
                                ...
                                value: function(t) {
                                    ...
                                    if (1 === e.length && "characterData" === e[0].type && e[0].target.data.match(R) && this.scroll.find(e[0].target)) {
                                        var o = this.scroll.find(e[0].target),
                                            ...
                                            h = n && {
                                                oldRange: j(n.oldRange, -a),
                                                newRange: j(n.newRange, -a)
                                            };
                    ...
                    (function(t, n) {
                        var r = "__lodash_hash_undefined__",
                            ...
                            L = /^(?:0|[1-9]\d*)$/,
                            I = {};
                        I[i] = I["[object Array]"] = I[g] = I[E] = I[s] = I[a] = I[w] = I[_] = I[T] = I[A] = I[x] = I[l] = I[f] = I[h] = I[d] = I[v] = I[y] = I[m] = I[O] = I[S] = I[R] = I[N] = !0, I["[object Error]"] = I[u] = I[b] = !1;
                        var j = "object" == typeof t && t && t.Object === Object && t,
                            k = "object" == typeof self && self && self.Object === Object && self,
                            B = j || k || Function("return this")(),
                            M = e && !e.nodeType && e,
                        ...
                        function It(t, e, n, r, o, p, b) {
                            ...
                            return function(t, e) {
                                ...
                                M && (o = t[i = o]), Pt(P, i, It(o, e, n, r, i, t, b))
                            })), P
                        }
                    ...
                    (function(t, n) {
                        ...
                        var y, m, b, g = "object" == typeof t && t && t.Object === Object && t,
                            ...
                            L = N.toString,
                            I = C.hasOwnProperty,
                            j = (y = /[^.]+$/.exec(P && P.keys && P.keys.IE_PROTO || "")) ? "Symbol(src)_1." + y : "",
                            k = C.toString,
                            B = L.call(Object),
                            M = RegExp("^" + L.call(I).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                            D = A ? w.Buffer : void 0,
                            F = w.Symbol,
                            U = w.Uint8Array,
                        ...
                        function ot(t, e) {
                            var n = Ot(t),
                                ...
                                u = a.length;
                            for (var c in t) !e && !I.call(t, c) || s && ("length" == c || o && ("offset" == c || "parent" == c) || i && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || Et(c, u)) || a.push(c);
                            return a
                        }
                        ...
                        function st(t, e, n) {
                            var r = t[e];
                            I.call(t, e) && At(r, n) && (void 0 !== n || e in t) || ut(t, e, n)
                        }
                        ...
                        tt.prototype.clear = function() {
                            ...
                            var e = this.__data__;
                            return J ? void 0 !== e[t] : I.call(e, t)
                                    ...
                                    if (c) it(t, n, c);
                                        ...
                                        if (m) {
                                            var b = Ot(u),
                                                g = !b && Rt(u),
                                                E = !b && !g && It(u);
                                            y = u, b || g || E ? Ot(a) ? y = a : Lt(v = a) && St(v) ? y = function(t, e) {
                                                var n = -1,
                                                    r = t.length;
                                                for (e || (e = Array(r)); ++n < r;) e[n] = t[n];
                                                return e
                        ...
                        var xt = ht(function() {
                                ...
                                return Lt(t) && I.call(t, "callee") && !q.call(t, "callee")
                            },
                            Ot = Array.isArray;

                        function St(t) {
                            return null != t && Ct(t.length) && !Nt(t)
                        }
                        var Rt = K || function() {
                            return !1
                        };
                        ...
                        var kt, Bt = (kt = function(t, e, n) {
                            ...
                            for (o = kt.length > 3 && "function" == typeof o ? (r--, o) : void 0, i && function(t, e, n) {
                                    if (!Pt(n)) return !1;
                                    var r = typeof e;
                                    return !!("number" == r ? St(n) && Et(e, n.length) : "string" == r && e in n) && At(n[e], t)
                    ...
                    (function(t, n) {
                        var r = "__lodash_hash_undefined__",
                            ...
                            C = /^(?:0|[1-9]\d*)$/,
                            P = {};
                        P["[object Float32Array]"] = P["[object Float64Array]"] = P["[object Int8Array]"] = P["[object Int16Array]"] = P["[object Int32Array]"] = P["[object Uint8Array]"] = P["[object Uint8ClampedArray]"] = P["[object Uint16Array]"] = P["[object Uint32Array]"] = !0, P[a] = P[u] = P[S] = P[l] = P[R] = P[f] = P[h] = P[p] = P[v] = P[y] = P[b] = P[w] = P[_] = P[T] = P[O] = !1;
                        var L = "object" == typeof t && t && t.Object === Object && t,
                            I = "object" == typeof self && self && self.Object === Object && self,
                            j = L || I || Function("return this")(),
                            k = e && !e.nodeType && e,
                        ...
                        function It(t, e, n, r, s) {
                            return t === e || (null == t || null == e || !Zt(t) && !Zt(e) ? t != t && e != e : function(t, e, n, r, s, c) {
                                ...
                                if (O && !E) return c || (c = new Rt), p || Jt(t) ? Bt(t, e, n, r, s, c) : function(t, e, n, r, s, a, u) {
                                    switch (n) {
                                        case R:
                                ...
                                if (!(n & o)) {
                                    var N = E && J.call(t, "__wrapped__"),
                                        C = x && J.call(e, "__wrapped__");
                                    if (N || C) {
                                        var P = N ? t.value() : t,
                                            L = C ? e.value() : e;
                                        return c || (c = new Rt), s(P, L, n, r, c)
                                    }
                                }
                                return !!O && (c || (c = new Rt), function(t, e, n, r, i, s) {
                                    var a = n & o,
                                        u = Mt(t),
                                        c = u.length,
                                        l = Mt(e),
                        ...
                        function qt(t, e) {
                            return t === e || t != t && e != e
                        }(ft && Ht(new ft(new ArrayBuffer(1))) != R || ht && Ht(new ht) != v || pt && Ht(pt.resolve()) != g || dt && Ht(new dt) != _ || vt && Ht(new vt) != O) && (Ht = function(t) {
                            var e = Pt(t),
                        ...
                        function Qt(t) {
                            return null != (e = t) && Yt(e.length) && !Kt(e) ? Nt(t) : kt(t);
                            var e
                        }
                    ...
                    var N = Object(u.a)("quill:clipboard"),
                        C = [
                            ...
                            [Node.ELEMENT_NODE, function(t, e, n) {
                                ...
                                } else if (r.prototype instanceof i.BlockBlot && !k(e, "\n") && e.insert("\n"), "function" == typeof r.formats) return j(e, r.blotName, r.formats(t, n));
                                return e
                            }],
                            [Node.ELEMENT_NODE, function(t, e, n) {
                                ...
                                })), Object.keys(a).length > 0 ? j(e, a) : e
                            }],
                            [Node.ELEMENT_NODE, function(t, e) {
                                var n = {},
                                    r = t.style || {};
                                return "italic" === r.fontStyle && (n.italic = !0), "underline" === r.textDecoration && (n.underline = !0), "line-through" === r.textDecoration && (n.strike = !0), (r.fontWeight.startsWith("bold") || parseInt(r.fontWeight, 10) >= 700) && (n.bold = !0), Object.keys(n).length > 0 && (e = j(e, n)), parseFloat(r.textIndent || 0) > 0 ? (new o.a).insert("\t").concat(e) : e
                            }],
                            ["li", function(t, e, n) {
                                var r = n.query(t);
                        ...
                        I = function(t) {
                            ...
                            function s(t, e) {
                                ...
                                })), n.quill.root.addEventListener("paste", n.onCapturePaste.bind(S(n))), n.matchers = [], C.concat(n.options.matchers).forEach((function(t) {
                                    var e = _(t, 2),
                                        r = e[0],
                                        o = e[1];
                                    n.addMatcher(r, o)
                                ...
                                return function(t, e) {
                                    ...
                                    for (var p = o - i, d = p % 2 != 0, v = 0, y = 0, m = 0, b = 0, g = 0; g < a; g++) {
                                        for (var E = -g + v; E <= g - y; E += 2) {
                                            for (var w = u + E, _ = (S = E === -g || E !== g && l[w - 1] < l[w + 1] ? l[w + 1] : l[w - 1] + 1) - E; S < o && _ < i && t.charAt(S) === e.charAt(_);) S++, _++;
                                            if (l[w] = S, S > o) y += 2;
                                            else if (_ > i) v += 2;
                                            else if (d && (x = u + p - E) >= 0 && x < c && -1 !== f[x] && S >= (A = o - f[x])) return s(t, e, S, _)
                                        }
                                        for (var T = -g + m; T <= g - b; T += 2) {
                                            ...
                                            if (f[x] = A, A > o) b += 2;
                                                ...
                                                if ((w = u + p - T) >= 0 && w < c && -1 !== l[w])
                                                    if (_ = u + (S = l[w]) - w, S >= (A = o - A)) return s(t, e, S, _)
                                            }
                                        }
                                    }
                                    return [
        ...
        941430: (t, e, n) => {
            ...
            var o = n(205482),
                i = (n(212763), n(612151), n(821046), n(276089)),
                s = n(483305);
            n(523546), n(419094);
            const a = { ...r || (r = n.t(o, 2))
                },
...
//# sourceMappingURL=sourcemaps/3dd13573d5b77f96.vendor.js.map